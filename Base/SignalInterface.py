...
class Signal(object):
    ...
    def __init__(self, **kwargs):
        ...
        self.frequence = kwargs['frequence']
    def tonumpy(self):
        '''
...
class WdmSignal(object):
    ...
    def __init__(self, signals, grid_size,multiplexed_filed):
        '''
        ...
        self.center_frequence = np.min(self.absolute_frequences) + np.max(self.absolute_frequences)
        self.center_lambda = Signal.freq2lamb(self.center_frequence)
        self.multiplexed_filed = multiplexed_filed
    @property
    def data_sample_in_fiber(self):
        return self.multiplexed_filed
    ...
    def absolute_frequences(self):
        ...
        :return:
        '''
        return np.array([signal.frequence for signal in self.signals])
...
class QamSignal(Signal):
    ...
    def __init__(self, symbol_rate, mf, symbol_length, sps, sps_in_fiber,
                 is_from_numpy=False, is_dp=True,frequence = 193.1e12):
        '''
